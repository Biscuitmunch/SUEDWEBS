      ...
      <div className={styles.bulletedList}>
        <ul>
          <li>
            ...
            Server) is a long-running modded Terraria server, with a progression
            boss fight planned for each week. This website provides information
            and scheduling for upcoming and available boss fights.
          </li>
          <li>
            Some weeks will have multiple boss fights planned (but no more than
            two). Half week boss fights are considered less relevant and may be
            skipped by those who cannot otherwise make it.
          </li>
          <li>
            In addition, some fights are marked as being longer sessions or mini
            events (mini events don't contribute toward the boss count for a
            week).
          </li>
          <li>
